<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard_User.Master" AutoEventWireup="true" CodeBehind="Add_serv_Provider.aspx.cs" Inherits="WebApplication1.Add_serv_Provider" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h3 class="text-center" style="color:#EEFFFF;">Enter Service Provider Details</h3>
                ...
                <div class="row row1">
                    <div class="col-sm-12">
                        <div class="row p-1">
                            ...
                            <div class="col-sm-5">
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="tb1" style="width:100%;"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-sm-5 text-center">
                            ...
                            <div class="col-sm-5">
                                <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" CssClass="tb1" style="width:100%;"></asp:TextBox>
                            </div>
                        </div>
                        <br />
                        <div class="row p-1">
                            ...
                            <div class="col-sm-5">
                                <asp:TextBox ID="TextBox3" runat="server" MaxLength="16" CssClass="tb1" style="width:100%;"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row row1">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <asp:TextBox ID="TextBox4" runat="server" CssClass="tb1" style="width:100%;"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-5 text-center">
                        ...
                        <div class="col-sm-5">
                            <asp:TextBox ID="TextBox5" runat="server" TextMode="Number" MaxLength="10" CssClass="tb1" style="width:100%;"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <asp:TextBox ID="TextBox6" runat="server" TextMode="Email" CssClass="tb1" style="width:100%;"></asp:TextBox>
